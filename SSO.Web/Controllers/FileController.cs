...
namespace SSO.Web.Controllers
{
    ...
    public class FileController : BaseController
    {
        ...
        public ActionResult GetFileList(int pageIndex = 1, int pageSize = 10, string from = "", string filter = "", string fileType = "all", DateTime? startTime = null, DateTime? endTime = null, Dictionary<string, string> sorts = null, bool delete = false)
        {
            FileClientService fileClientService = new FileClientService(fileServiceUrl, JwtManager.GetAuthorization());
            var filelist = fileClientService.GetFileList(pageIndex, pageSize, from, filter, (FileType)Enum.Parse(typeof(FileType), fileType), startTime, endTime, sorts, delete);
