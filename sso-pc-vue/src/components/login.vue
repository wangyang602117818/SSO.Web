  ...
  <div class="container" v-on:keyup.enter="handleSubmit">
      ...
      <div class="login_content">
        <div class="input_wrap">
          <div :class="userErrorLine?'input_content error':'input_content'">
            ...
            <input type="text" id="userId" placeholder="用户编号" v-model="userId" @input="userChange" />
          </div>
          <div class="input_error">{{userIdExists?'':'用户编号是必填项'}}</div>
        </div>
        <div class="input_wrap">
          <div :class="passWordErrorLine?'input_content error':'input_content'">
            <svg viewBox="64 64 896 896" width="14px" height="14px" fill="#aaaaaa">
              <path
          ...
          <div class="input_error">{{passWordExists?'':'用户密码是必填项'}}</div>
        </div>
      </div>
    ...
    <transition name="move">
      <div class="toast" v-show="mssage_show">
        <svg viewBox="0 0 1024 1024" version="1.1" p-id="2179" width="18" height="18">
          <path
        ...
        this.$axios
          ...
          .then(response => {
            if (response.code == 0) {
              ...
              setTimeout(()=>{this.mssage_show=false},2000);
              this.loading = false;
            }
          });
      } else {
